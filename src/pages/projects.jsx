  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <ul
          role="list"
          className="relative grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3"
        >
          {projects.map((project) => (
            <Card as="li" key={project.name}>
              ...
              <p className="relative z-10 flex mt-6 text-sm font-medium transition text-zinc-400 group-hover:text-blue-500 dark:text-zinc-200">
