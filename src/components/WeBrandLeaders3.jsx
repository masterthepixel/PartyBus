        ...
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
          <div className="relative sm:py-16 lg:py-0">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              {/* Testimonial card*/}
              <div className="glow-sm relative overflow-hidden rounded-2xl pt-64 pb-10">
                <Image
                  ...
                  <blockquote className="mt-8">
                    <div className="relative text-lg font-medium text-white md:flex-grow">
                      ...
                      <p className="relative">
                        ...
                        firms, Djembe Mediahas far exceeded my expectations in a
                        ...
                        to effortlessly shift gears when needed, is impressive
                        and comforting.
                      </p>
                    </div>
          ...
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              <h2 className="text-6xl font-bold tracking-tight text-zinc-800 dark:text-amber-300 ">
                We offer comprehensive brand support including but not limited
                to the following mediums:
              </h2>
              <div className="mt-6 space-y-6 text-zinc-600 dark:text-zinc-100 ">
                <p className="text-lg">
                  If you are eager to grow yourself to attract more
                  opportunities and revenue, and you have time to dedicate to
                  building your personal brand platform but you need a team to
                  help you, Djembe Mediais the partner for you. We can help you
                  clarify your message and define a personal branding strategy
            ...
            <div className="mt-10">
              <dl className="grid grid-cols-2 gap-x-4 gap-y-8">
                {stats.map((stat) => (
                  ...
                  >
                    <dt className="text-base font-medium text-zinc-600 dark:text-amber-300">
                      {stat.label}
                    </dt>
                  </div>
                ))}
