        ...
        <div className="md:ml-auto md:w-1/2 md:pl-10">
          ...
          <div className="mt-8">
            <div className="inline-flex rounded-md shadow">
              <a
                href="#"
                className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-zinc-900 bg-white border border-transparent rounded-md hover:bg-gray-50"
              >
