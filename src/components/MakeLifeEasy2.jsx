      ...
      <div className="">
        <div className="relative max-w-xl lg:max-w-7xl">
          <div className="relative">
            <h2 className="... mx-auto max-w-3xl bg-gradient-to-b from-sky-600 to-blue-500 bg-clip-text py-2 font-body text-5xl font-[600] tracking-tighter text-transparent drop-shadow-lg filter dark:text-amber-300 lg:text-center lg:text-6xl">
              Enjoy the ride with Pro-Bus
            </h2>
          </div>

          <div className="relative mt-12 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
            <div className="relative -mx-4 lg:mt-0" aria-hidden="true"></div>
          </div>
                      ...
                      <div className="relative lg:col-span-2">
                        ...
                        <blockquote className="text-white ">
                          <p className="text-base font-medium ">
                            As a mom having to coordinate a party bus to
                            transport teenagers to and from their dance, it
                            caused some anxiety. Pro-Bus helped to ease my
                            anxiety by explaining their typical homecoming pick
                            up and drop off. I was impressed with their quick
                            response, promptness for pick up and drop off. The
                            driver was courteous and helpful teaching the teens
                            the Bluetooth music setup. They were all in good
                            hands.”
                          </p>
