...
import avatarImage from '@/images/wheel.png'
...
function MobileNavigation(props) {
  return (
    <Popover {...props}>
      <Popover.Button className="z-10 text-md group flex items-center rounded-full bg-white/90 px-4 py-2 font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
        Menu
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/glossary">Glossary</NavItem>
        {/*
...
function AvatarContainer({ className, ...props }) {
  return (
    <div
      className={clsx(className, '-mt-6 flex h-4 w-16  justify-center p-0.5')}
      {...props}
    />
  )
}
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx('  object-contain ', large ? 'w-auto' : 'h-24')}
        priority
      />
    </Link>
  )
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Container
            className="top-[var(--header-top,theme(spacing.6))] w-full font-body"
            style={{ position: 'var(--header-inner-position)' }}
          >
